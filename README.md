...
//////////////////////////////////
https://docs.nestjs.com/techniques/database 👈docs✌

step1). First we need to install CLI for intalling globally
npm i -g @nestjs/cli
...
For database => npm install --save @nestjs/typeorm typeorm mysql2
